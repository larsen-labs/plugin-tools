...
'''Larsen Tools Tests: device requests'''
...
def _test_500_response():
    ...
    assert MOCK['calls'][0]['url'] == 'fake_plugin_url/api/v1/celery_script'
...
def _test_200_response():
    ...
    assert MOCK['calls'][0]['url'] == 'fake_plugin_url/api/v1/bot/state'
    print(bot_state)
