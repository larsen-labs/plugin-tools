...
import time
from plugin_tools import app, device
...
def run_tests(TEST, app_login):
    ...
    TESTS = [
        ...
        {'command': device.run_plugin, 'kwargs': {'label': 'take-photo'}},
        {'command': device.find_home, 'kwargs': {'axis': 'y'},
         'expected': {'log': ['F12']}},
        {'command': device.home, 'kwargs': {'axis': 'z'},
         'expected': {'log': ['G00 Z0']}},
        {'command': device.install_plugin, 'kwargs': {'url': URL}},
        {'command': device.install_first_party_plugin, 'kwargs': {}},
        ...
        {'command': device.remove_plugin,
         'kwargs': {'package': 'plugin'}},
